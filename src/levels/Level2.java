...
public class Level2 {
    ...
    public static void main(String[] args) {
        ...
        double average = teachers.stream()
                ...
                .mapToInt(Teacher::getSalary)
                .average()
                .orElse(0); // Valeur par défaut si aucune correspondance
        ...
        System.out.println("Enseignants dont le nom commence avec 'f': " + teachers1);

        /* TO DO 5: Retourner la liste des enseignants dont le nom commence par s */
        List<Teacher> teachers2 = teachers.stream()
                .filter(teacher -> teacher.getName().startsWith("s"))
                .collect(Collectors.toList());
        System.out.println("Enseignants dont le nom commence avec 's': " + teachers2);
